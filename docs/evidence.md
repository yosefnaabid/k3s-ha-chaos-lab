...
del cluster y las herramientas solo la maquetan, asi que la evidencia se puede
...
problemas, que es para lo que se hacen los simulacros. Lo que fallo:
...
laboratorio detras de un router domestico. Queda anotado como limite del
montaje, no como fallo de Kubernetes.
